...
- ⏳ Format Museum — illustrated archive of every annotation format with history, examples, real dataset links, and timeline (see internal doc: `design/format-museum.md`)
